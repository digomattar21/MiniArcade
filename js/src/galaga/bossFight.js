class BossFight {
  constructor(canvas) {
    ...
    this.imgSrcs = ["../../../img/boss_left.png","../../../img/boss_right.png","../../../img/boss_middle.png","../../../img/boss_middle_open.png"]
  ...
  updateTimes() {
    ...
    if (this.laserLoad >2000 && this.laserLoad<2500){
        ...
        this.ctx.fillText(`LASER INCOMING`, this.x+10,this.y-10)
    }
