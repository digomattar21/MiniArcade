class BossFight {
  ...
  getSlope() {
    if (this.laserFired.length > 0) {
      return [
        this.laserFired[0].slope1,
        this.laserFired[0].slope2,
        this.laserFired[0].yInt1,
        this.laserFired[0].yInt2,
      ];
    }
  }
  ...
  drawSelf() {
    ...
    this.updateSelf();
    if (this.laserFired.length > 0) {
      this.laserFired[this.laserFired.length - 1].updateSelf(
        this.x + 30,
        this.y + 115
      );
    }
  ...
  createLaserShot() {
    if (this.laserOn) {
      switch (this.randlaserDir) {
        case "left":
          let laserShot = new LaserShot(this.canvas, this.x + 30, this.y + 115);
